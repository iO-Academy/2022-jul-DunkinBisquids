...
# Database: biscuits
# Generation Time: 2022-09-13 10:25:54 +0000
# ************************************************************
...
CREATE TABLE `biscuits` (
  ...
  `dunk` int(11) unsigned NOT NULL DEFAULT 0,
  `flunk` int(10) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
